...
echo "</table><br>";
if ( $pages > 1 )  // 顯示上一頁
   echo "<a href='harvestM.php?Pages=".($pages-1).
        "'>上一頁</a>| ";
for ( $i = 1; $i <= $total_pages; $i++ )
   if ($i != $pages)
     echo "<a href=\"harvestM.php?Pages=".$i."\">".
          $i."</a> ";
   else
     echo $i." ";
...
<br/>
<p class="w3-center">
 <a href="managerView.php#harvest" class="w3-button w3-black w3-hover-red w3-round w3-padding-large w3-large">
 回上頁</a></p>
</body>
</html>