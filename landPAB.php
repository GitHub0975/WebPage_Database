...
echo "</table><br>";
if ( $pages > 1 )  // 顯示上一頁
   echo "<a href='landPAB.php?Pages=".($pages-1).
        "'>上一頁</a>| ";
for ( $i = 1; $i <= $total_pages; $i++ )
   if ($i != $pages)
     echo "<a href=\"landPAB.php?Pages=".$i."\">".
          $i."</a> ";
   else
     echo $i." ";
...
echo "<p class='w3-center'>";
 echo "<a href='plantView.php#land' class='w3-button w3-black w3-hover-red w3-round w3-padding-large w3-large'>";
 echo "回上頁</a></p>";
 }else if($de==2){
echo "<br/>";
echo "<p class='w3-center'>";
 echo "<a href='administractor.php#land' class='w3-button w3-black w3-hover-red w3-round w3-padding-large w3-large'>";
 echo "回上頁</a></p>";
 }else if($de==3){
echo "<br/>";
echo "<p class='w3-center'>";
 echo "<a href='businessView.php#land' class='w3-button w3-black w3-hover-red w3-round w3-padding-large w3-large'>";
 echo "回上頁</a></p>";
 }
?>
</body>
