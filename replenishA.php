...
echo "<table class='w3-large' style='font-family:DFKai-sb'><tr><th>進貨日期</th>";
echo "<th>單價</th><th>進貨量</th><th>原料編號</th><th></th></tr>";
$j = 1;
...
echo "</table><br>";
if ( $pages > 1 )  // 顯示上一頁
   echo "<a href='replenishA.php?Pages=".($pages-1).
        "'>上一頁</a>| ";
for ( $i = 1; $i <= $total_pages; $i++ )
   if ($i != $pages)
     echo "<a href=\"replenishA.php?Pages=".$i."\">".
          $i."</a> ";
   else
     echo $i." ";
